...
```bash
wget -c -O /tmp/ayugram_7.0.9_amd64.deb https://github.com/kunshakolime/trixie-tricks/releases/download/ayugram-7.0.9/ayugram_7.0.9_amd64.deb && sudo apt install /tmp/ayugram_7.0.9_amd64.deb
```
