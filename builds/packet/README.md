...
```bash
wget -c -O /tmp/packet_0.6.1_amd64.deb https://github.com/kunshakolime/trixie-tricks/releases/download/packet-0.6.1/packet_0.6.1_amd64.deb && sudo apt install /tmp/packet_0.6.1_amd64.deb
```
